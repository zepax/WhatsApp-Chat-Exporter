...
class AutomationManager:
    ...
    def _load_automation_config(self):
        ...
        try:
            ...
            self.schedule_config = ScheduleConfig(**active_config.get("scheduling", {}))
    ...
    def _perform_cleanup(self):
        ...
        try:
            ...
            cleanup_date = datetime.now() - timedelta(
                days=self.automation_config.cleanup_after_days
            )
    ...
    def _send_email_notification(
        self, type: str, message: str, details: Dict[str, Any]
    ):
    ...
    def _send_slack_notification(
        ...
        try:
            ...
            response = requests.post(
                self.notification_config.slack_webhook_url, json=payload, timeout=10
            )
    ...
    def _send_discord_notification(
        ...
        try:
            ...
            response = requests.post(
                self.notification_config.discord_webhook_url, json=payload, timeout=10
            )
            response.raise_for_status()
...
def create_default_profiles(config_manager: ConfigurationManager):
    ...
    basic_config = {
        ...
        "security": {"anonymize_data": False, "encrypt_output": False},
    }
    ...
    professional_config = {
        ...
        "security": {"anonymize_data": True, "encrypt_output": True},
        "automation": {
            "auto_cleanup": True,
    ...
    security_config = {
        ...
        "processing": {"max_workers": 2, "use_cache": False, "cache_directory": ""},
        "output": {
            "generate_excel": True,
            "generate_pdf": True,
            "generate_dashboard": False,
    ...
    config_manager.create_profile(
        "basic", basic_config, "Basic content analysis with minimal features"
    )
    config_manager.create_profile(
        "professional",
        professional_config,
        "Advanced analysis with all features enabled",
    )
    config_manager.create_profile(
        "security", security_config, "Security-focused analysis with enhanced privacy"
    )
