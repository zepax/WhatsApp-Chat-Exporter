...
def get_cond_for_empty(enable: bool, jid_field: str, broadcast_field: str) -> str:
    """Return a SQL condition for filtering empty chats securely."""
    ...
    return (
        f"AND (chat.hidden=0 OR {jid_field}='status@broadcast' OR {broadcast_field}>0)"
    )
...
def get_chat_condition(
    ...
    """Return a SQL condition and parameters for chat filtering securely."""
